<script>
  ...
  /**
   * THE DUSK — where the descent sets down. Markup verbatim from
   * design/v19/first-run.html at 159ec9f: the earth-shadow stack (violet
   * above, the Belt of Venus, then ember), the afterglow hugging the limb with
   * no white core because the sun is already under, and the same lockup the
   * dawn wears, so both ends of a session show one face.
   *
...
<div id="dusk">
  ...
  <div class="world" aria-hidden="true"><svg viewBox="0 0 1600 1000" preserveAspectRatio="xMidYMid slice">
    ...
    <ellipse cx="800" cy="700" rx="1000" ry="180" fill="url(#d-belt)" filter="url(#d-b24)"/>
  ...
  <div class="loginchrome">
    <div class="lockup" style="top:31vh">
      <div class="glyph" id="dusk-glyph"><svg width="64" height="64" viewBox="0 0 200 200">
        <circle cx="100" cy="100" r="72" fill="none" stroke="#6b7292" stroke-width="9"/>
        <circle cx="163" cy="63.5" r="20" fill="#e0b06a"/></svg></div>
