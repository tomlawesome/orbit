...
export const generatedPdfFixtures = [
...
export function generatedPdfWithHarmlessFeatureName(): Buffer {
  return classicCompressedPdf(pageContent("Harmless text /JavaScript /Launch /RichMedia /XFA"));
}

export function generatedPdfWithCompressedJavaScript(): Buffer {
  return compressedJavaScriptObjectStreamPdf();
}

export function generatedPdfWithCatalogFeature(feature: string): Buffer {
  const content = pageContent();
