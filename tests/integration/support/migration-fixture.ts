...
export const EXPECTED_TABLE_COLUMNS: Record<string, string[]> = {
  ...
  document_jobs: ["id", "document_id", "kind", "generation", "status", "attempts", "locked_at", "lease_expires_at", "lease_token", "last_error", "completed_at", "created_at", "updated_at"],
...
export const EXPECTED_INDEXES: Record<string, ExpectedIndex> = {
  ...
  document_job_claim_idx: { table: "document_jobs", columns: ["status", "created_at"], unique: false },
