...
| CON-19 | The mark, ratified | **Owner decision 2026-08-13:** Orbit's mark is exactly two geometric shapes — the year ring and the planet riding it. Nothing ever sits inside the ring (no threshold, no sun, no trail). Dress is the only variable: hero = 3D planet body + glow (slow 40s drift on live surfaces), chrome = 3D body, one-ink = both shapes flat. The word always sets plain beside it. The three-arc gesture mark retires; all bespoke wordmark treatments are dropped. Sheet: mockups-brand-decision.html | **ratified** |
