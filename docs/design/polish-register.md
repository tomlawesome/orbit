...
| CON-19 | The mark, ratified | **Owner decision 2026-08-13 (amended same day):** Orbit's mark is exactly three geometric shapes — the year ring, the planet riding it, and a plain filled circle at the centre (the household). The centre is always flat: no inner ring, no gradient, no glow. The planet is the only dressed shape: 3D body + glow at hero (slow 40s drift on live surfaces), 3D body in chrome, flat in one-ink. The word always sets plain. The three-arc mark retires; all bespoke wordmark treatments are dropped. Sheet: mockups-brand-decision.html | **ratified** |
