...
| CON-19 | The mark, ratified | **Owner decision 2026-08-13 (final):** Orbit's mark is exactly three FLAT geometric shapes — the year ring, the planet riding it, and a plain filled circle at the centre (the household). No gradients, no glow, no 3D, at any size, in any medium; colour comes from the theme tokens; the planet may drift slowly on live surfaces (the only permitted motion). The word always sets plain. The three-arc mark retires; all bespoke wordmark treatments are dropped. Sheet: mockups-brand-decision.html | **ratified** |
