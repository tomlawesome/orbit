...
- [ADR-0024: Tier 1 metadata encrypts under one per-household DEK beneath the existing KEK, with a derived per-household blind index](0024-tiered-metadata-encryption.md) (Proposed)
- [ADR-0025: Model extraction is a schema-bound, evidence-grounded proposer on a fixed internal endpoint, gated by a hold-out corpus](0025-local-model-extraction.md) (Proposed)
