...
- [ADR-0022: The instance is claimed with an installer-generated secret, and a lost administrator is recovered from the deployment host](0022-bootstrap-claim-and-lost-administrator-recovery.md) (Proposed)
