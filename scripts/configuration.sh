...
is_deprecated_secret() {
  case "$1" in
    OIDC_CLIENT_SECRET|SESSION_SECRET|DOCUMENT_KEK|POSTGRES_PASSWORD|VAPID_PRIVATE_KEY|SMTP_PASSWORD|DATABASE_URL|SMTP_URL)
      return 0
      ;;
  esac
  return 1
