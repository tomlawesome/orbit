...
export const FULL_PAGE_CORPUS: CorpusDocument[] = [
  ...
  },
  {
    ...
    // - recurrenceMonths is 1 because billing is monthly; scheduleKind is 'renewal' because the tracked date is when the minimum term completes and the contract rolls onto its next arrangement, not a service event.
